...
| `valid/reciprocal-commitments.json` | pass | SPEC §4.9 reciprocal — two commitment legs of one contract (Geerts & McCarthy 2002) |
...
| `invalid/reciprocal-non-commitment.json` | fail (integrity) | SPEC §4.9 reciprocal must link two commitments |
